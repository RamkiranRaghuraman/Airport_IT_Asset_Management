    ...
    public partial class ArchiveAsset : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                archCautionMessage.Visible = false;
                lblAfterArchive.Visible = false;
        ...
        {
            if (ddlArchStatus.SelectedIndex == 0 || String.IsNullOrEmpty(tbCalDate.Text))
            {
                archCautionMessage.Visible = true;
                ddlArchStatus.BorderColor = System.Drawing.Color.OrangeRed;
                tbCalDate.BorderColor = System.Drawing.Color.OrangeRed;
            }
            ...
            else
            {
                ...
                if (check > 0)
                {
                    ...
                    btnArchAsset.Visible = false;
                    lblAfterArchive.Text += " with AssetId : " + @paramValue;
                    lblAfterArchive.Visible = true;
                }
                con1.Close();
            }
        }
