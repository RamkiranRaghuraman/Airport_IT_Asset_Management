    ...
    public partial class EditAsset : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                editCautionMessage.Visible = false;
                lblAfterEdit.Visible = false;
                ...
                SqlCommand cmdUsage = new SqlCommand("SELECT ID, Reference_Data FROM [AITINV].[dbo].[AITInventoryRefData] where Category = 'UsageWithinDept' ORDER BY Reference_Data", con1);
                ...
                object x3 = dat.Rows[0]["Manufacturer_RefID"];
                if (x3 != null)
                {
                ...
                object x4 = dat.Rows[0]["Model_RefID"];
                if (x4 != null)
                {
                ...
                object x5 = dat.Rows[0]["Status_RefID"];
                if (x5 != null)
                {
                ...
                object x = dat.Rows[0]["Usage_RefID"];
                if (x != DBNull.Value)
                {
                ...
                // object x = (dat.Rows[0]["Usage_RefID"] == null) ? null : dat.Rows[0]["Usage_RefID"].ToString();
        ...
        protected void tbnEditSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (ddlEdAssetTypeID.SelectedIndex == 0 || ddlEdDeptName.SelectedIndex == 0 || ddlEdManuRefID.SelectedIndex == 0 ||
                    ddlEdModelRefID.SelectedIndex == 0 || ddlEdStatusId.SelectedIndex == 0 || ddlEdUsageRefID.SelectedIndex == 0 || String.IsNullOrEmpty(tbEdMark4Replace.Text))
            {
                //MessageBox.Show("Please fill all the mandatory fields");
                editCautionMessage.Visible = true;
                ddlEdAssetTypeID.BorderColor = System.Drawing.Color.OrangeRed;
                ddlEdDeptName.BorderColor = System.Drawing.Color.OrangeRed;
                ddlEdManuRefID.BorderColor = System.Drawing.Color.OrangeRed;
                ddlEdModelRefID.BorderColor = System.Drawing.Color.OrangeRed;
                ddlEdStatusId.BorderColor = System.Drawing.Color.OrangeRed;
                ddlEdUsageRefID.BorderColor = System.Drawing.Color.OrangeRed;
                tbEdMark4Replace.BorderColor = System.Drawing.Color.OrangeRed;
            }
            ...
            else
            {
                ...
                if (check > 0)
                {
                    ...
                    lblAfterEdit.Text += " with AssetId : " + @paramValue;
                    lblAfterEdit.Visible = true;
                }
            }
        }
    }
